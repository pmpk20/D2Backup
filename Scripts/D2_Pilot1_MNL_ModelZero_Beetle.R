...
database <- database[database$Insect_PlanA == 3, ]
...
apollo_control = list(
  modelDescr = "D2_Pilot1_MNL_ModelZero_Beetle",
  modelName  = "D2_Pilot1_MNL_ModelZero_Beetle", ## Added dates last verified
...
D2_Pilot1_MNL_ModelZero_Beetle = apollo_estimate(apollo_beta, 
                                              apollo_fixed, 
                                              apollo_probabilities, 
                                              apollo_inputs)

# Model output and results here alongside saving information
apollo_modelOutput(D2_Pilot1_MNL_ModelZero_Beetle,
                   modelOutput_settings = list(printPVal = TRUE))



apollo_saveOutput(D2_Pilot1_MNL_ModelZero_Beetle,saveOutput_settings = list(printPVal=TRUE))
# saveRDS(D2_Pilot1_MNL_ModelZero_Beetle, here("CEoutput/ModelOne","D2_Pilot1_MNL_ModelZero_Beetle.rds"))
...
#
nsim <- 1000
betas <- D2_Pilot1_MNL_ModelZero_Beetle$estimate
vcmat <- D2_Pilot1_MNL_ModelZero_Beetle$robvarcov
#
#
...
Plot_Beetle <- PlotData %>% ggplot(aes(y = variable, 
                        x = mean)) +
  geom_boxplot() +
