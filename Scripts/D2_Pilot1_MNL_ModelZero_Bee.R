...
apollo_control = list(
  modelDescr = "D2_Pilot1_MNL_ModelZero_Bee",
  modelName  = "D2_Pilot1_MNL_ModelZero_Bee", ## Added dates last verified
...
D2_Pilot1_MNL_ModelZero_Bee = apollo_estimate(apollo_beta, 
                                          apollo_fixed, 
                                          apollo_probabilities, 
                                          apollo_inputs)

# Model output and results here alongside saving information
apollo_modelOutput(D2_Pilot1_MNL_ModelZero_Bee,
                   modelOutput_settings = list(printPVal = TRUE))



apollo_saveOutput(D2_Pilot1_MNL_ModelZero_Bee,saveOutput_settings = list(printPVal=TRUE))
# saveRDS(D2_Pilot1_MNL_ModelZero_Bee, here("CEoutput/ModelOne","D2_Pilot1_MNL_ModelZero_Bee.rds"))
...
#
nsim <- 1000
betas <- D2_Pilot1_MNL_ModelZero_Bee$estimate
vcmat <- D2_Pilot1_MNL_ModelZero_Bee$robvarcov
#
#
