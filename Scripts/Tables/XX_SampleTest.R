...
Test_Gender <- AMR::g.test(
  Data_Covariates$Q2Gender %>% table() %>% as.numeric() %>% data.frame() %>% t() %>% divide_by(Total),
  p = c(50.5, 48.5, 0.5),
  rescale.p = TRUE
)
...
Row1_Gender <- cbind(
  "Variable" = "Gender",
  "Category" = "Male",
  "N" = data.frame(Data_Covariates$Q2Gender %>% table() %>% as.numeric())[1, ] %>% round(3),
  "Sample (%)" = data.frame(
    Data_Covariates$Q2Gender %>% table() %>% as.numeric() %>% data.frame() %>% t() %>% divide_by(Total)
  )[, 1] %>% round(3) %>% multiply_by(100),
  "Population (%)" = 50.50,
  "PV" = Test_Gender$p.value %>% as.numeric() %>% round(3)
)
...
Row2_Gender <- cbind(
  "Variable" = "Gender",
  "Category" = "Female",
  "N" = data.frame(Data_Covariates$Q2Gender %>% table() %>% as.numeric())[2, ] %>% round(3),
  "Sample (%)" = data.frame(
    Data_Covariates$Q2Gender %>% table() %>% as.numeric() %>% data.frame() %>% t() %>% divide_by(Total)
...
Data_Covariates$AgeCategory <- ifelse(Data_Covariates$Q1Age <= 24,
                             0,
                             ifelse(
                               Data_Covariates$Q1Age <= 34,
                               1,
                               ifelse(
                                 Data_Covariates$Q1Age <= 44,
                                 2,
                                 ifelse(Data_Covariates$Q1Age <= 54, 3,
                                        ifelse(Data_Covariates$Q1Age <= 64, 4, 5))
                               )
                             ))


## Using the labels from SE for quotas
Data_Covariates$AgeCategory_Labelled <- ifelse(
  Data_Covariates$Q1Age <= 24,
  "18-24",
  ifelse(
    Data_Covariates$Q1Age <= 34,
    "25-34",
    ifelse(
      ...
      "35-44",
      ifelse(
        Data_Covariates$Q1Age <= 54,
        "45-54",
        ifelse(Data_Covariates$Q1Age <= 64,
               "55-64",
               "65+")
      )
    )
...
Test_ExactAge <- AMR::g.test(
  Data_Covariates$AgeCategory %>% table() %>% as.numeric() %>% data.frame() %>% t() %>% divide_by(Total),
  p = c(11, 17, 16, 18, 15, 23),
  rescale.p = TRUE
)
...
Row1_ExactAge <- cbind(
  ...
  "Category" = "18 - 29",
  "N" = data.frame(Data_Covariates$AgeCategory %>% table() %>% as.numeric())[1, ] %>% round(3),
  "Sample (%)" = data.frame(
    Data_Covariates$AgeCategory %>% table() %>% as.numeric() %>% data.frame() %>% t() %>% divide_by(Total)
  )[, 1] %>% round(3) %>% multiply_by(100),
  "Population (%)" = 11,
...
Row2_ExactAge <- cbind(
  "Variable" = "AgeCategory",
  "Category" = "30 - 39",
  "N" = data.frame(Data_Covariates$AgeCategory %>% table() %>% as.numeric())[2, ] %>% round(3),
  "Sample (%)" = data.frame(
    Data_Covariates$AgeCategory %>% table() %>% as.numeric() %>% data.frame() %>% t() %>% divide_by(Total)
  )[, 2] %>% round(3) %>% multiply_by(100),
  "Population (%)" = 17,
...
Row3_ExactAge <- cbind(
  "Variable" = "AgeCategory",
  "Category" = "40 - 49",
  "N" = data.frame(Data_Covariates$AgeCategory %>% table() %>% as.numeric())[3, ] %>% round(3),
  "Sample (%)" = data.frame(
    Data_Covariates$AgeCategory %>% table() %>% as.numeric() %>% data.frame() %>% t() %>% divide_by(Total)
...
Row4_ExactAge <- cbind(
  "Variable" = "AgeCategory",
  "Category" = "50 - 59",
  "N" = data.frame(Data_Covariates$AgeCategory %>% table() %>% as.numeric())[4, ] %>% round(3),
  "Sample (%)" = data.frame(
    Data_Covariates$AgeCategory %>% table() %>% as.numeric() %>% data.frame() %>% t() %>% divide_by(Total)
...
Row5_ExactAge <- cbind(
  "Variable" = "AgeCategory",
  "Category" = "60 - 69",
  "N" = data.frame(Data_Covariates$AgeCategory %>% table() %>% as.numeric())[5, ] %>% round(3),
  "Sample (%)" = data.frame(
    Data_Covariates$AgeCategory %>% table() %>% as.numeric() %>% data.frame() %>% t() %>% divide_by(Total)
...
Row6_ExactAge <- cbind(
  "Variable" = "AgeCategory",
  "Category" = "70+",
  "N" = data.frame(Data_Covariates$AgeCategory %>% table() %>% as.numeric())[6, ] %>% round(3),
  "Sample (%)" = data.frame(
    Data_Covariates$AgeCategory %>% table() %>% as.numeric() %>% data.frame() %>% t() %>% divide_by(Total)
...
Test_EthnicityDummyWhite <- AMR::g.test(
  Data_Covariates$Q5Ethnicity_Dummy %>% table() %>% as.numeric() %>% data.frame() %>% t() %>% divide_by(Total),
  p = c(13, 87),
  rescale.p = TRUE
)
...
Row1_EthnicityDummyWhite <- cbind(
  ...
  "Category" = "Non-white",
  "N" = data.frame(Data_Covariates$Q5Ethnicity_Dummy %>% table() %>% as.numeric())[1, ] %>% round(3),
  "Sample (%)" = data.frame(
    Data_Covariates$Q5Ethnicity_Dummy %>% table() %>% as.numeric() %>% data.frame() %>% t() %>% divide_by(Total)
  )[, 1] %>% round(3) %>% multiply_by(100),
  "Population (%)" = 13,
...
Row2_EthnicityDummyWhite <- cbind(
  "Variable" = "EthnicityDummyWhite",
  "Category" = "White",
  "N" = data.frame(Data_Covariates$Q5Ethnicity_Dummy %>% table() %>% as.numeric())[2, ] %>% round(3),
  "Sample (%)" = data.frame(
    Data_Covariates$Q5Ethnicity_Dummy %>% table() %>% as.numeric() %>% data.frame() %>% t() %>% divide_by(Total)
  )[, 2] %>% round(3) %>% multiply_by(100),
  "Population (%)" = 87,
...
Test_Country <- AMR::g.test(
  Data_Covariates$Q3Country %>% table() %>% as.numeric() %>% data.frame() %>% t() %>% divide_by(Total),
  p = c(88, 8, 4),
  rescale.p = TRUE
)
...
Row1_Country <- cbind(
  "Variable" = "Country",
  "Category" = "England",
  "N" = data.frame(Data_Covariates$Q3Country %>% table() %>% as.numeric())[1, ] %>% round(3),
  "Sample (%)" = data.frame(
    Data_Covariates$Q3Country %>% table() %>% as.numeric() %>% data.frame() %>% t() %>% divide_by(Total)
  )[, 1] %>% round(3) %>% multiply_by(100),
  "Population (%)" = 87.8,
  "PV" = Test_Country$statistic %>% as.numeric() %>% round(3)
)
...
Row2_Country <- cbind(
  "Variable" = "Country",
  "Category" = "Scotland",
  "N" = data.frame(Data_Covariates$Q3Country %>% table() %>% as.numeric())[2, ] %>% round(3),
  "Sample (%)" = data.frame(
    Data_Covariates$Q3Country %>% table() %>% as.numeric() %>% data.frame() %>% t() %>% divide_by(Total)
  )[, 2] %>% round(3) %>% multiply_by(100),
  "Population (%)" = 8.2,
  "PV" = paste0("PV: ", Test_Country$p.value %>% as.numeric() %>% round(3))
)
...
Row3_Country <- cbind(
  "Variable" = "Country",
  "Category" = "Wales",
  "N" = data.frame(Data_Covariates$Q3Country %>% table() %>% as.numeric())[3, ] %>% round(3),
  "Sample (%)" = data.frame(
    Data_Covariates$Q3Country %>% table() %>% as.numeric() %>% data.frame() %>% t() %>% divide_by(Total)
  )[, 2] %>% round(3) %>% multiply_by(100),
  "Population (%)" = 4.2,
...
Rows_Country <- rbind(Row1_Country, Row2_Country, Row3_Country)
...
Test_Urbanicity <- AMR::g.test(
  Data_Covariates$Q4Urban %>% table() %>% as.numeric() %>% data.frame() %>% t() %>% divide_by(Total),
  p = c(18.5, 81.5),
  rescale.p = TRUE
)
...
Row1_Urbanicity <- cbind(
  "Variable" = "Urbanicity",
  "Category" = "Rural",
  "N" = data.frame(Data_Covariates$Q4Urban %>% table() %>% as.numeric())[1, ] %>% round(3),
  "Sample (%)" = data.frame(
    Data_Covariates$Q4Urban %>% table() %>% as.numeric() %>% data.frame() %>% t() %>% divide_by(Total)
  )[, 1] %>% round(3) %>% multiply_by(100),
  "Population (%)" = 18.5,
...
Row2_Urbanicity <- cbind(
  "Variable" = "Urbanicity",
  "Category" = "Urban",
  "N" = data.frame(Data_Covariates$Q4Urban %>% table() %>% as.numeric())[2, ] %>% round(3),
  "Sample (%)" = data.frame(
    Data_Covariates$Q4Urban %>% table() %>% as.numeric() %>% data.frame() %>% t() %>% divide_by(Total)
  )[, 2] %>% round(3) %>% multiply_by(100),
  "Population (%)" = 81.5,
...
# 
# 
# Data_Covariates$Occupation <-
#   Data_Covariates$Now..thinking.of.the.chief..income.earner.in.your.household..which.might.be.you.or.somebody.else.in.the..household..which.of.these.best.describes.the.current.status.of.the.chief.income..earner.
# 
# 
# Data_Covariates$Occupation <-
#   ifelse(
#     Data_Covariates$Occupation == "Student/Full time education",
#     1,
#     ifelse(
#       Data_Covariates$Occupation == "Unemployed/on benefit",
#       2,
#       ifelse(Data_Covariates$Occupation == "Retired", 3, 4)
#     )
#   )
# 
# 
# Test_Occupation <- g.test(
#   Data_Covariates$Occupation %>% table() %>% as.numeric() %>% data.frame() %>% t() %>% divide_by(Total),
#   p = c(8.2, 4,  24, 76),
#   rescale.p = TRUE
# )
# 
...
#   "Variable" = "Occupation",
#   "Category" = "Student",
#   "N" = data.frame(Data_Covariates$Occupation %>% table() %>% as.numeric())[1, ] %>% round(3),
#   "Sample (%)" = data.frame(
#     Data_Covariates$Occupation %>% table() %>% as.numeric() %>% data.frame() %>% t() %>% divide_by(Total)
#   )[, 1] %>% round(3) %>% multiply_by(100),
#   "Population (%)" = 8.2,
...
#   "Variable" = "Occupation",
#   "Category" = "Employed",
#   "N" = data.frame(Data_Covariates$Occupation %>% table() %>% as.numeric())[2, ] %>% round(3),
#   "Sample (%)" = data.frame(
#     Data_Covariates$Occupation %>% table() %>% as.numeric() %>% data.frame() %>% t() %>% divide_by(Total)
#   )[, 2] %>% round(3) %>% multiply_by(100),
#   "Population (%)" = 76,
...
Data_Covariates$IncomeCategories <-
  ifelse(
    (Data_Covariates$IncomeMidpoints_PlusMissing * 12) < Population$Groups[1],
    0,
    ifelse(
      (Data_Covariates$IncomeMidpoints_PlusMissing * 12)  < Population$Groups[2],
      1,
      ifelse(
        (Data_Covariates$IncomeMidpoints_PlusMissing * 12) < Population$Groups[3], 2, 3)
    )
  )


Test_IncomeCategories <- g.test(
  Data_Covariates$IncomeCategories %>% table() %>% as.numeric() %>% data.frame() %>% t() %>% divide_by(Total),
  p = c(26, 19, 25, 30),
  rescale.p = TRUE
)
...
Row1_IncomeCategories <- cbind(
  ...
  "Category" = "£0 – £20,500",
  "N" = data.frame(Data_Covariates$IncomeCategories %>% table() %>% as.numeric())[1, ] %>% round(3),
  "Sample (%)" = data.frame(
    Data_Covariates$IncomeCategories %>% table() %>% as.numeric() %>% data.frame() %>% t() %>% divide_by(Total)
  )[, 1] %>% round(3) %>% multiply_by(100),
  "Population (%)" = 26,
...
Row2_IncomeCategories <- cbind(
  ...
  "N" = data.frame(Data_Covariates$IncomeCategories %>% table() %>% as.numeric())[2, ] %>% round(3),
  "Sample (%)" = data.frame(
    Data_Covariates$IncomeCategories %>% table() %>% as.numeric() %>% data.frame() %>% t() %>% divide_by(Total)
  )[, 2] %>% round(3) %>% multiply_by(100),
  "Population (%)" = 19,
...
Row3_IncomeCategories <- cbind(
  ...
  "N" = data.frame(Data_Covariates$IncomeCategories %>% table() %>% as.numeric())[3, ] %>% round(3),
  "Sample (%)" = data.frame(
    Data_Covariates$IncomeCategories %>% table() %>% as.numeric() %>% data.frame() %>% t() %>% divide_by(Total)
  )[, 3] %>% round(3) %>% multiply_by(100),
  "Population (%)" = 25,
...
Row4_IncomeCategories <- cbind(
  "Variable" = "IncomeCategories",
  "Category" = "£54,000+",
  "N" = data.frame(Data_Covariates$IncomeCategories %>% table() %>% as.numeric())[4, ] %>% round(3),
  "Sample (%)" = data.frame(
    Data_Covariates$IncomeCategories %>% table() %>% as.numeric() %>% data.frame() %>% t() %>% divide_by(Total)
  )[, 4] %>% round(3) %>% multiply_by(100),
  "Population (%)" = 30,
...
Table1 %>%
  fwrite(
    sep = ",",
    here("OtherOutput/Tables", "Table1_SampleVsQuota.txt"),
    row.names = TRUE,
    quote = FALSE
  )
